...
namespace WapplerSystems\InfomaniakVod\Resource\Rendering;
...
class InfomaniakVodRenderer implements FileRendererInterface
{
    ...
    {
        return ($file->getMimeType() === 'video/infomaniakvod' || $file->getExtension() === 'infomaniakvod') && $this->getOnlineMediaHelper($file) !== false;
    }
